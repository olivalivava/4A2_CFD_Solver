...
def calc_secondary(av,b):
    ...
    b['vx'] = b['rovx']/b['ro']
    b['vy'] = b['rovy']/b['ro']
    v2 = abs(b['vx'] * b['vx'] + b['vy'] * b['vy'])
    b['v'] = np.sqrt(v2)
    b['rov'] = b['ro']*b['v']
    b['t'] = (b['roe']/b['ro'] - 0.5*v2)/av['cv']
    b['tstag'] = b['t'] + v2/(2*av['cp'])
    b['mach'] = np.sqrt(v2/(av['gam']*av['rgas']*b['t']))
    b['rostag'] = b['ro'] * ((b['tstag']/b['t'])**(1/(av['gam']-1)))
    b['p'] = b['ro']*av['rgas']*b['t']
    b['pstag'] = b['rostag'] * av['rgas']*b['tstag']
